...
>
	<nav class="flex justify-center">
		<ul class="flex gap-16 text-3xl text-white font-bold font-display">
			...
			<li>
				<a href="https://github.com/3nt3/open-vaporphase">Git</a>
			</li>
			<li>
				<a href="https://draw.openvaporphase.lol">Excalidraw</a>
			</li>
		</ul>
	</nav>
	<div class="mb-32">
		...
		<h2 class="text-4xl text-white font-bold mt-16 font-body">Work in progress.</h2>
	</div>
</main>
